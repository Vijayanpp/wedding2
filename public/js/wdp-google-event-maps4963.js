...
jQuery(document).ready(function($){
    ...
    function eventInit() { 
        ...
        var eventMapCenter1=new google.maps.LatLng(10.099077, 76.276976); // Create a LatLng object to center the map on a specific point
        ...
        var eventMapCenter2=new google.maps.LatLng(9.966948, 76.284083); // Create a LatLng object to center the map on a specific point
